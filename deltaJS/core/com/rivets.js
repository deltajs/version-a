...
// license: MIT
  ...
  var sightglass = include("delta.core.com.sightglass"), Rivets, bindMethod, unbindMethod, _ref,
  ...
  Rivets.View = (function() {
    function View(els, models, options) {
      ...
      if (!this.els || !(this.els.jquery || this.els instanceof Array)) {
        this.els = [this.els];
      }
  ...
  Rivets.Binding = (function() {
    ...
    Binding.prototype.eventHandler = function(fn) {
      ...
      return function(ev) {
        ev.dispatcher = binding.model;
        ev.dispatchersPath = binding.observer.objectPath;
        ev.rootDispatcher = binding.observer.objectPath[0];
  ...
  Rivets["public"].binders['on-*'] = {
    ...
    routine: function(el, value) {
      ...
      this.handler = this.eventHandler( value.bind( this.model ) );
  ...
  var rivets = Rivets.factory(sightglass);
